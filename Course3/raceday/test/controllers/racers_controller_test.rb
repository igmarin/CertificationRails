...
class RacersControllerTest < ActionController::TestCase
  ...
  test "should create racer" do
    assert_difference('Racer.count') do
      post :create, racer: { first_name: @racer.first_name, gender: @racer.gender, last_name: @racer.last_name, number: @racer.number, secs: @racer.secs }
    end
  ...
  test "should update racer" do
    patch :update, id: @racer, racer: { first_name: @racer.first_name, gender: @racer.gender, last_name: @racer.last_name, number: @racer.number, secs: @racer.secs }
    assert_redirected_to racer_path(assigns(:racer))
  end
